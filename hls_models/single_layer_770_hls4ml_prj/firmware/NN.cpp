...
void NN(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<batch_normalization_1_scale_t, 2>(s4, "s4.txt");
        nnet::load_weights_from_txt<batch_normalization_1_bias_t, 2>(b4, "b4.txt");
        loaded_weights = true;
    }
#endif
    ...
    nnet::normalize<layer2_t, result_t, config4>(layer2_out, layer4_out, s4, b4); // batch_normalization_1
#ifndef __SYNTHESIS__
    nnet::save_layer_output<result_t>(layer4_out, "batch_normalization_1", N_LAYER_2);
#endif
