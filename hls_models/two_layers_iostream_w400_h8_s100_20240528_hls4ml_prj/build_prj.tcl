...
add_files firmware/${project_name}_axi.cpp -cflags "-std=c++0x -Wno-attributes"
add_files firmware/${project_name}.cpp -cflags "-std=c++0x -Wno-attributes"
add_files -tb ${project_name}_test.cpp -cflags "-std=c++0x -Wno-attributes"
