...
def create_filename(args):
    if args.quantize or args.prune:
        return './qkeras_v2_filter_pnq.h5'
    return './qkeras_v2_filter.h5'
...
def get_qkeras_model(args):
    ...
    if args.prune:
        ...
        pruning_params = {'pruning_schedule': tfmot.sparsity.keras.PolynomialDecay(initial_sparsity=0.50, final_sparsity=0.90, begin_step=200, end_step=1000)}
...
def main(args):
    ...
    plt.semilogy()
    plt.savefig('model-v2-filter-pruned.png')
